...
function Button({ title, onClick, width, loading, padding, noIcon }: Props) {
  return (
    ...
    >
      ...
      <span className="absolute top-0 left-0 -mt-2 -ml-12 h-8 w-20 -translate-x-1 -rotate-45 transform bg-white opacity-10 transition-all duration-300 ease-out group-hover:translate-x-0"></span>
